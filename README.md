...
Evaluate accessibility for different social groups
Key Findings
Average monthly income: 2,280,000 MNT
Recommended transport spending: approximately 3% of income
...
Economic reasoning using percentage-of-income models
Scenario comparison:
Flat fare system
...
Project Structure
Metro-Ticket-Price-Model/
│── Metro Ticket Price formula.ipynb
│── README.md
Technologies Used
Python (Google Colab)
Basic data analysis
...
Sensitive or unnecessary output data has been removed from the notebook to ensure safe and clean sharing.
